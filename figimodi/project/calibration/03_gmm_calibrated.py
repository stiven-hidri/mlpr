...
if __name__ == '__main__':
    ...
    np.save('..\\data\\03_gmm_scores_c_q-log.npy', logRatioCumulative)
    np.save('..\\data\\03_gmm_labels_c_q-log.npy', cumulativeLabels)

    actualDCF, minDCF = bayer_error_plots(logRatioCumulative, cumulativeLabels)
    np.save('..\\data\\03_gmm_actualDCF_c_q-log.npy', actualDCF)
    np.save('..\\data\\03_gmm_minDCF_c_q-log.npy', minDCF)